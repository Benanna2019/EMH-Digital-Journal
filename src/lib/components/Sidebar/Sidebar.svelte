...
<nav
	...
	class="{$isOpen
		...
		: 'absolute -translate-x-full'} 3xl:w-80 border-gray-150 z-30 flex h-full max-h-screen min-h-screen w-3/4 flex-none transform flex-col overflow-y-auto border-r bg-white pb-10 transition duration-200 ease-in-out sm:w-1/2 sm:pb-0 md:w-1/3 lg:relative lg:z-auto lg:w-56 lg:translate-x-0 lg:bg-gray-50 2xl:w-72 dark:border-gray-800 dark:bg-gray-900 lg:dark:bg-gray-900"
>
